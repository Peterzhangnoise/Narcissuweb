...
//=============================================================================
// ** TITLES SETTING （雨起与雨落整理）
//=============================================================================	
	Moghunter.musicbook_titles = [
		["sen02","一号線","Route 1 作編曲 sentive"],
		["2na","ナルキッソス(Narcissus -inst-)","Narcissus -inst- 作曲·編曲：菊池創"],
		["a01","サクラ（１２０円の春より）","Sakura (from 120yen Spring) 作曲：ebi　アレンジ：藤間仁(Elements Garden) -"],
		["o012","ここにいる","I'm Here 作詞：海富一"],
		["o01","ここにいる-inst-","I'm Here 作曲：石橋弘史　アレンジ：石橋弘史"],
		["n04","终末の过ごし方より","How to Pass a Weekend 作曲：矢野雅士　アレンジ：猫野こめっと"],
		["n03","ラムネ79's-ver.1","Ramune 79's 作曲：藤間仁(Elements Garden)　アレンジ：館内明(TGZ)"],
		["o02","スカーレット"," Scarlet -arranged- 作曲：上松範康(Elements Garden)　アレンジ：石橋弘史(BOL)"],
		["2ka012","ラムネ79's-ver.2","作曲：藤間仁(Elements Garden)アレンジ：猫野こめっと"],
		["215_012","15ｃｍ","作詞：Takashi(Σ-sigma-)　作曲：sin(Σ-sigma-)　Vocal：KAKO"],
		["2o01","パイナップルの木","パイナップルの木 作曲：Barbarian On The Groove(注:该资料来源网易云)"],
		["2eb032","夕立雲","Rain Cloud 作曲·編曲：ebi(Sound Union)"],
		["e02","銀のクーペ","Silver Coupe 作曲：ebi(Sound Union)"],
		["n05","ナルキッソス-inst-","Narcissus -inst- 作曲·編曲：菊池創"],
		["2eb022","１２０円の冬より"," From 120yen of Autumn 作曲：藤間仁(Elements Garden)アレンジ：石橋弘史(BOL)"],
		["2mi03","鳴る高架線 2007","Ringing Railway 作曲・編曲：ebi(Sound Union)"],
		["3_12","エメラルドの海-ver.2"," Emerald Sea 作編曲：ＭＡＳＡ"],
		["sen032","7F","7F 作曲：sentive"],
		["2eb021","姫子のテーマ","Himeko's Theme 作曲·編曲：ebi(Sound Union)"],	
		["2n12","夕化粧 アレンジver","Preparing For Night 作曲：４４３　アレンジ：猫野こめっと"],
		["e01","ナルキッソス-inst2-","Narcissus 作曲：ebi(Sound Union)"],	
		["2na_fb","ナルキッソス-short ver-","Narcissus 作詞：riya　作曲·編曲：菊池創　Vocal：eufonius"],
		["2sen02","誰が為に","For Someone's Sake 作曲：sentive"],	
		["2sou01","南向きの窓"," Southern-facing Window 作曲·編曲：souten"],
		["2mi02","飲み込む嘘"," Accepted Lies 作曲·編曲：水月陵 "],	
		["e013","Narsissu ~セツミのテーマ~","Narcissu ~Setsumi's Theme~ 作詞：片岡とも　作曲：ebi　Vocal：REM"],
		["3_1","エメラルドの海-ver.1","エメラルドの海 作曲：eufonius(大概是变调版)"],	
		["2ono01","ロードスター","Roadster 作曲·編曲：onoken"],
		["2ka013","ラムネ79's-ver.3","弹珠汽水 (ラムネ) - ラムネ79's (波子汽水79's) 作曲：Elements Garden"]
	];
